...
void GrGLSetDefaultGLInterface() {
  __android_log_print(ANDROID_LOG_DEBUG,"NDKWebKit","**** GrGLSetDefaultGLInterface");
  ...
  if (!host_StubGL_initialized) {
    __android_log_print(ANDROID_LOG_DEBUG,"NDKWebKit","**** GrGLSetDefaultGLInterface: init");
    GrGLSetGLInterface(&cmd_buffer_interface);
    host_StubGL_initialized = true;
  }
  else {
    __android_log_print(ANDROID_LOG_DEBUG,"NDKWebKit","**** GrGLSetDefaultGLInterface: no init");
  }
}
