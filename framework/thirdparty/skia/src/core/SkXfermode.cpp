...
private:
    SkClearXfermode(const ProcCoeff& rec)
        : SkProcCoeffXfermode(rec, kClear_Mode)
    {
    }
...
private:
    SkSrcXfermode(const ProcCoeff& rec)
        : SkProcCoeffXfermode(rec, kSrc_Mode)
    {
    }
    typedef SkProcCoeffXfermode INHERITED;
};
...
private:
    SkDstInXfermode(const ProcCoeff& rec)
        : SkProcCoeffXfermode(rec, kDstIn_Mode)
    {
    }
...
struct Multiply4f {
    ...
    static Sk4px Xfer(const Sk4px& src, const Sk4px& dst)
    {
        return Sk4px::Wide(src.mulWiden(dst.alphas().inv()) + dst.mulWiden(src.alphas().inv()) + src.mulWiden(dst))
            .div255RoundNarrow();
    }
    static const bool kFoldCoverageIntoSrcAlpha = false;
...
private:
    SkT4fXfermode(const ProcCoeff& rec)
        : SkProcCoeffXfermode(rec, ProcType::kMode)
    {
    }
...
private:
    SkT4pxXfermode(const ProcCoeff& rec)
        : SkProcCoeffXfermode(rec, ProcType::kMode)
    {
    }
...
private:
    SkDstOutXfermode(const ProcCoeff& rec)
        : SkProcCoeffXfermode(rec, kDstOut_Mode)
    {
    }
...
// boymue comment
extern SkProcCoeffXfermode* SkPlatformXfermodeFactory(const ProcCoeff& rec, SkXfermode::Mode mode) { return NULL; };
// boymue comment
extern SkXfermodeProc SkPlatformXfermodeProcFactory(SkXfermode::Mode mode) { return NULL; };
...
SkXfermode* create_mode(int iMode)
{
    ...
    case SkXfermode::kSrcATop_Mode:
        return SkT4pxXfermode<SrcATop4f>::Create(rec);
    case SkXfermode::kDstATop_Mode:
        return SkT4pxXfermode<DstATop4f>::Create(rec);
    case SkXfermode::kXor_Mode:
        return SkT4pxXfermode<Xor4f>::Create(rec);
    case SkXfermode::kPlus_Mode:
        return SkT4pxXfermode<Plus4f>::Create(rec);
    case SkXfermode::kModulate_Mode:
        return SkT4pxXfermode<Modulate4f>::Create(rec);
    case SkXfermode::kScreen_Mode:
        return SkT4pxXfermode<Screen4f>::Create(rec);
    case SkXfermode::kMultiply_Mode:
        return SkT4pxXfermode<Multiply4f>::Create(rec);
    case SkXfermode::kDifference_Mode:
        return SkT4pxXfermode<Difference4f>::Create(rec);
    case SkXfermode::kExclusion_Mode:
        return SkT4pxXfermode<Exclusion4f>::Create(rec);
    default:
        break;
    }
#endif
    ...
    switch (mode) {
    case SkXfermode::kSrcATop_Mode:
        return SkT4fXfermode<SrcATop4f>::Create(rec);
    case SkXfermode::kDstATop_Mode:
        return SkT4fXfermode<DstATop4f>::Create(rec);
    case SkXfermode::kXor_Mode:
        return SkT4fXfermode<Xor4f>::Create(rec);
    case SkXfermode::kPlus_Mode:
        return SkT4fXfermode<Plus4f>::Create(rec);
    case SkXfermode::kModulate_Mode:
        return SkT4fXfermode<Modulate4f>::Create(rec);
    case SkXfermode::kScreen_Mode:
        return SkT4fXfermode<Screen4f>::Create(rec);
    case SkXfermode::kMultiply_Mode:
        return SkT4fXfermode<Multiply4f>::Create(rec);
    case SkXfermode::kDifference_Mode:
        return SkT4fXfermode<Difference4f>::Create(rec);
    case SkXfermode::kExclusion_Mode:
        return SkT4fXfermode<Exclusion4f>::Create(rec);
    default:
        break;
    }
#endif
...
#ifdef SK_DEBUG
static bool require_255(SkPMColor src)
{
    return SkGetPackedA32(src) == 0xFF;
}
