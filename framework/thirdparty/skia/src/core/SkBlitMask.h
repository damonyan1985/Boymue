...
public:
     ...
     */
    // boymue comment
    static ColorProc PlatformColorProcs(SkColorType, SkMask::Format, SkColor) { return NULL; };
     ...
     */
    // boymue comment
    static BlitLCD16RowProc PlatformBlitRowProcs16(bool isOpaque) { return NULL; };
     ...
     */
    // boymue comment
    static RowProc PlatformRowProcs(SkColorType, SkMask::Format, RowFlags) { return NULL; };
};
