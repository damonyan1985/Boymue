...
#import <OpenGLES/ES2/gl.h>
 ...
 static GrGLFuncPtr ios_get_gl_proc_in_lib(void* ctx, const char name[]) {
     SkASSERT(ctx);
...
static GrGLFuncPtr ios_get_gl_proc(void* ctx, const char name[]) {
    ...
    return ios_get_gl_proc_in_lib(ctx, name);
    
//    GLProcGetter getter;
//    return GrGLAssembleGLESInterface(&getter, ios_get_gl_proc_in_lib);
}

const GrGLInterface* GrGLCreateNativeInterface() {
     
    //return GrGLAssembleInterface(NULL, ios_get_gl_proc);
    GLProcGetter getter;
