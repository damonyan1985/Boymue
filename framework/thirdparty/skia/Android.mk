...
LOCAL_C_INCLUDES += \
  ...
  $(LOCAL_PATH)/../../frameworks/opt/emoji \
  ...
  $(LOCAL_PATH)/../opt/emoji

ifeq ($(NO_FALLBACK_FONT),true)
	LOCAL_CFLAGS += -DNO_FALLBACK_FONT
endif

LOCAL_MODULE:= libndkskia
LOCAL_CFLAGS += -DSK_BUILD_FOR_ANDROID_NDK -DHAVE_ENDIAN_H
...
LOCAL_MODULE:= libndkskiagpu
LOCAL_MODULE_TAGS := optional
LOCAL_LDFLAGS := -lEGL -lGLESv2 -llog
...
$(call import-module,external/giflib)
$(call import-module,external/jpeg)
$(call import-module,external/libpng)
$(call import-module,external/webp)
