...
void MacroAssembler::Fadd(const FPRegister& fd, const FPRegister& fn,
                          const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fadd(fd, fn, fm);
}

void MacroAssembler::Fccmp(const FPRegister& fn, const FPRegister& fm,
                           StatusFlags nzcv, Condition cond) {
  DCHECK(allow_macro_instructions_);
  DCHECK((cond != al) && (cond != nv));
...
void MacroAssembler::Fcsel(const FPRegister& fd, const FPRegister& fn,
...
void MacroAssembler::Fdiv(const FPRegister& fd, const FPRegister& fn,
                          const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fdiv(fd, fn, fm);
}

void MacroAssembler::Fmadd(const FPRegister& fd, const FPRegister& fn,
                           const FPRegister& fm, const FPRegister& fa) {
  DCHECK(allow_macro_instructions_);
  fmadd(fd, fn, fm, fa);
}

void MacroAssembler::Fmax(const FPRegister& fd, const FPRegister& fn,
                          const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fmax(fd, fn, fm);
}

void MacroAssembler::Fmaxnm(const FPRegister& fd, const FPRegister& fn,
                            const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fmaxnm(fd, fn, fm);
}

void MacroAssembler::Fmin(const FPRegister& fd, const FPRegister& fn,
                          const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fmin(fd, fn, fm);
}

void MacroAssembler::Fminnm(const FPRegister& fd, const FPRegister& fn,
                            const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fminnm(fd, fn, fm);
}
...
void MacroAssembler::Fmsub(const FPRegister& fd, const FPRegister& fn,
                           const FPRegister& fm, const FPRegister& fa) {
  DCHECK(allow_macro_instructions_);
  fmsub(fd, fn, fm, fa);
}

void MacroAssembler::Fmul(const FPRegister& fd, const FPRegister& fn,
                          const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fmul(fd, fn, fm);
}
...
void MacroAssembler::Fnmadd(const FPRegister& fd, const FPRegister& fn,
                            const FPRegister& fm, const FPRegister& fa) {
  DCHECK(allow_macro_instructions_);
  fnmadd(fd, fn, fm, fa);
}

void MacroAssembler::Fnmsub(const FPRegister& fd, const FPRegister& fn,
                            const FPRegister& fm, const FPRegister& fa) {
  DCHECK(allow_macro_instructions_);
  fnmsub(fd, fn, fm, fa);
}
...
void MacroAssembler::Fsub(const FPRegister& fd, const FPRegister& fn,
                          const FPRegister& fm) {
  DCHECK(allow_macro_instructions_);
  fsub(fd, fn, fm);
}
...
void MacroAssembler::Scvtf(const FPRegister& fd, const Register& rn,
                           unsigned fbits) {
  DCHECK(allow_macro_instructions_);
  scvtf(fd, rn, fbits);
}
...
void MacroAssembler::Ucvtf(const FPRegister& fd, const Register& rn,
                           unsigned fbits) {
  DCHECK(allow_macro_instructions_);
  ucvtf(fd, rn, fbits);
}
...
void MacroAssembler::SmiUntagToDouble(FPRegister dst, Register src,
                                      UntagMode mode) {
  DCHECK(dst.Is64Bits() && src.Is64Bits());
...
void MacroAssembler::SmiUntagToFloat(FPRegister dst, Register src,
                                     UntagMode mode) {
...
void MacroAssembler::JumpIfBothSmi(Register value1, Register value2,
...
void MacroAssembler::JumpIfEitherSmi(Register value1, Register value2,
...
void MacroAssembler::JumpIfEitherNotSmi(Register value1, Register value2,
                                        Label* not_smi_label) {
  JumpIfBothSmi(value1, value2, NULL, not_smi_label);
}

void MacroAssembler::JumpIfBothNotSmi(Register value1, Register value2,
                                      Label* not_smi_label) {
...
void MacroAssembler::IsObjectNameType(Register object, Register type,
                                      Label* fail) {
  CompareObjectType(object, type, type, LAST_NAME_TYPE);
  B(hi, fail);
}

void MacroAssembler::IsObjectJSStringType(Register object, Register type,
                                          Label* not_string, Label* string) {
...
void MacroAssembler::ClaimBySMI(const Register& count_smi, uint64_t unit_size) {
  ...
  const Operand size(count_smi, (shift >= 0) ? (LSL) : (LSR),
                     (shift >= 0) ? (shift) : (-shift));
