...
enum Shift { NO_SHIFT = -1, LSL = 0x0, LSR = 0x1, ASR = 0x2, ROR = 0x3 };
...
#define LOAD_STORE_PAIR_OP_LIST(V)                                         \
  V(STP, w, 0x00000000), V(LDP, w, 0x00400000), V(LDPSW, x, 0x40400000),   \
      V(STP, x, 0x80000000), V(LDP, x, 0x80400000), V(STP, s, 0x04000000), \
      V(LDP, s, 0x04400000), V(STP, d, 0x44000000), V(LDP, d, 0x44400000)
...
#define LOAD_STORE_OP_LIST(V)                                                  \
  V(ST, RB, w, 0x00000000), V(ST, RH, w, 0x40000000), V(ST, R, w, 0x80000000), \
      V(ST, R, x, 0xC0000000), V(LD, RB, w, 0x00400000),                       \
      V(LD, RH, w, 0x40400000), V(LD, R, w, 0x80400000),                       \
      V(LD, R, x, 0xC0400000), V(LD, RSB, x, 0x00800000),                      \
      V(LD, RSH, x, 0x40800000), V(LD, RSW, x, 0x80800000),                    \
      V(LD, RSB, w, 0x00C00000), V(LD, RSH, w, 0x40C00000),                    \
      V(ST, R, s, 0x84000000), V(ST, R, d, 0xC4000000),                        \
      V(LD, R, s, 0x84400000), V(LD, R, d, 0xC4400000)
